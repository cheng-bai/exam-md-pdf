...
- 示例：
  `2026上海市建平中学高一期末数学试卷/`
  `2026上海市建平中学高一期末数学试卷/2026上海市建平中学高一期末数学试卷-学生版.md`
  `2026上海市建平中学高一期末数学试卷/2026上海市建平中学高一期末数学试卷-学生版.pdf`
- 文件夹名只描述试卷本身，不放版本类型和提交日期；版本类型写在目录内文件名里，例如 `学生版`、`解析版`、`OCR审校学生版`。
...
- `exams/<归档目录>/<中文语义文件名>.md`: 最终 Markdown 主源稿。
- `exams/<归档目录>/<中文语义文件名>.pdf`: 最终可打印 PDF。
