...
3. 已知角 $a$ 的终边经过点 $P\left( {1, - 2}\right)$ ，则 $\sin a =$ ___.
...
【详解】设等差数列 $\left\{  {a}_{n}\right\}$ 的公差为 $d$ ,依题意, $d = \frac{{a}_{26} - {a}_{6}}{{26} - 6} = \frac{{11} - 1}{20} = \frac{1}{2}$ ,
...
【详解】第一步先从非零的四个数中选择一个作为百位数字, 有 4 种选法,
...
9. 已知向量 $\overrightarrow{a} = \left( {\cos x,\sin x}\right) ,\overrightarrow{b} = \left( {3,\sqrt{3}}\right)$ ，且 $x \in  \left\lbrack  {0,\frac{\pi }{2}}\right\rbrack$ ，则 $\overrightarrow{a}$ 在 $\overrightarrow{b}$ 方向上的数量投影的取值范围为___
...
11. 将函数 $y = {x}^{2}, x \in  \left\lbrack  {0,1}\right\rbrack$ 的图象绕坐标原点逆时针方向旋转角 $\theta \left( {0 \leq  \theta  \leq  a}\right)$ 得到曲线
...
![bo_d7obhr491nqc738535qg_4_240_534_324_293_0.jpg](images/bo_d7obhr491nqc738535qg_4_240_534_324_293_0.jpg)
...
二、选择题 (本大题共有 4 题, 满分 18 分, 第 13、14 题每题 4 分, 第 15、16 题每题 5 分) 每题有且只有一个正确选项.考生应在答题纸的相应位置, 将代表

## 正确选项的小方格涂黑.

13. 已知陈述句 $a$ 是 $\beta$ 的充分非必要条件. 若集合 $M = \{ x \mid  x$ 满足 $a\} , N = \{ x \mid  x$ 满足 $\beta \}$ ,则 $M$ 与 $N$ 的关系为( )
...
16. 对任意平面向量 $\overrightarrow{a}\text{ 、 }\overrightarrow{b}\text{ 、 }\overrightarrow{c}$ 及任意实数 $\lambda$ ,已知运算 $\odot$ 满足以下三条性质: (I)
...
## 三、解答题 (本大您共有 5 题, 满分 78 分) 解答下列各题必须在答题纸的相应 位置写出必要的步骤.
...
18. 如图，在 ${ABC}$ 中， $\angle {ACB} = {90}^{ \circ  }$ ， ${DA}\bot$ 平面 ${ABC}$ ， $M$ ， $N$ 分别是线段 ${AC}$ 、 ${DB}$ 的中点.

![bo_d7obhr491nqc738535qg_6_244_1104_357_355_0.jpg](images/bo_d7obhr491nqc738535qg_6_244_1104_357_355_0.jpg)
...
![bo_d7obhr491nqc738535qg_7_1083_833_369_297_0.jpg](images/bo_d7obhr491nqc738535qg_7_1083_833_369_297_0.jpg)
...
(3)在深度神经网络中，信号经过多层传播可抽象为一个迭代过程. 设数列 $\left\{  {x}_{n}\right\}$ 满足 ${x}_{n + 1} = \sigma \left( {x}_{n}\right)$ ,其中 $n$ 为正整数. 证明: 存在唯一实数 $A \in  \left( {0,1}\right)$ ,使得 $\sigma \left( A\right)  = A$ ,且对任意实数 ${X}_{1}$ 和任意正整数 $n$ ,都有 $\left| {{x}_{n + 2} - A}\right|  \leq  {\left( \frac{1}{4}\right) }^{n}$ . 参考答案及解析:
...
10. 已知正四面体上的四个面上分别写有1、2、3、4，游戏中甲、乙轮流抛掷该四面体，谁抛出底面数字等于 4 则获胜且游戏结束. 甲先开始，则甲获胜的概率为___.
...
![bo_d7obhr491nqc738535qg_11_238_1835_327_293_0.jpg](images/bo_d7obhr491nqc738535qg_11_238_1835_327_293_0.jpg)
...
13. 已知陈述句 $a$ 是 $\beta$ 的充分非必要条件. 若集合 $M = \left\{  {x\left| {\;x}\right. }\right\}$ 满足 $a\} , N = \left\{  {x\left| {\;x}\right. }\right\}$ 满足 $\beta \}$ ,则 $M$ 与 $N$ 的关系为( )

A. $M \subset  N$ B. $M \supset  N$ C. $M = N$ D.
...
16. 对任意平面向量 $\overrightarrow{a}$ 、 $\overrightarrow{b}$ 、 $\overrightarrow{c}$ 及任意实数 $\lambda$ ，已知运算 $\odot$ 满足以下三条性质:(I)
...
![bo_d7obhr491nqc738535qg_17_242_757_359_354_0.jpg](images/bo_d7obhr491nqc738535qg_17_242_757_359_354_0.jpg)
...
![bo_d7obhr491nqc738535qg_18_241_286_374_345_0.jpg](images/bo_d7obhr491nqc738535qg_18_241_286_374_345_0.jpg)
...
19. 某款足球机器人射点球时，射门点与球门中心的水平偏差(单位:cm)服从正态分布. 在正常状态下，偏差 $X \sim  N\left( {0,{20}^{ \circ  }}\right)$ ，规定 $\left| X\right|  > {60}$ 为“严重失误”.
...
![bo_d7obhr491nqc738535qg_20_242_1574_369_292_0.jpg](images/bo_d7obhr491nqc738535qg_20_242_1574_369_292_0.jpg)
...
![bo_d7obhr491nqc738535qg_23_240_222_334_267_0.jpg](images/bo_d7obhr491nqc738535qg_23_240_222_334_267_0.jpg)
...
![bo_d7obhr491nqc738535qg_23_240_1540_334_270_0.jpg](images/bo_d7obhr491nqc738535qg_23_240_1540_334_270_0.jpg)
...
(2)设交叉熵损失函数 ${L}_{t}\left( \widehat{y}\right)  =  - \left\lbrack  {t\ln \widehat{y} + \left( {1 - t}\right) \ln \left( {1 - \widehat{y}}\right) }\right\rbrack$ ，用于衡量预测值 $\widehat{y}$ 与真实标签

$t$ 之间的差异,其中 $t \in  \{ 0,1\}$ . 试确定 $t$ 的值,使得 $z = {L}_{t}\left( {\sigma \left( x\right) }\right)$ 在 $\left( {-\infty , + \infty }\right)$ 上是减函数;
