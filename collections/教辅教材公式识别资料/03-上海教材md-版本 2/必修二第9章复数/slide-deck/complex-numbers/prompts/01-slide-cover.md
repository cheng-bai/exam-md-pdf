...
**Narrative Goal**: 建立章节主题，激发学生对复数的好奇心

**Key Content**:
- Headline: 第9章 复数
- Sub-headline: 从代数到几何的桥梁
- Tagline: 探索虚数的世界，连接代数与几何

**Visual**:
- 中央：大号标题 "第9章 复数"，白色粉笔字
- 下方：副标题 "从代数到几何的桥梁"，黄色粉笔
- 背景：黑板质感，右下角手绘复平面草图（z = a + bi）
- 装饰：粉笔绘制的数学符号（i, π, ∞）点缀四周

**Layout**: title-hero, 居中对称
