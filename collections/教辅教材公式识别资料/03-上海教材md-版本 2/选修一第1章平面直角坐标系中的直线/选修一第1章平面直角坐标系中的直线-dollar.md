...
(3)直线的两点式方程:经过两点 $M\left( {{x}_{1},{y}_{1}}\right)$ 、 $N\left( {{x}_{2},{y}_{2}}\right)$ 和 ${x}_{1}$ 写 $\left( {{y}_{1} \neq  {x}_{2}\text{ 且 }{y}_{1} \neq  {y}_{2}}\right)$ 的直线的方程是 $\frac{y - {y}_{1}}{{y}_{2} - {y}_{1}} = \frac{x - {x}_{1}}{{x}_{2} - {x}_{1}}$ .
...
给定两条直线 ${l}_{1} : {a}_{1}x + {b}_{1}y + {c}_{1} = 0$ 与 ${l}_{2} : {a}_{2}x + {b}_{2}y + {c}_{2} = 0\left( {{a}_{1}\text{ 、 }{b}_{1}}\right.$ 不同时为零, ${a}_{2}\text{ 、 }{b}_{2}$ 不同时为零).
