...
<table><tr><td>三角函数</td><td>正弦函数 $y = \sin x$</td><td>余弦函数 $y = \cos x$</td><td>正切函数 $y = \tan x$</td></tr><tr><td>定义域</td><td>$\mathbf{R}$</td><td>$\mathbf{R}$</td><td>$\left\{  {x\left| {\;x \in  \mathbf{R}, x \neq  {k\pi } + \frac{\pi }{2}\left( {k \in  \mathbf{Z}}\right) }\right. }\right\}$</td></tr><tr><td>值域</td><td>[-1,1]</td><td>$\left\lbrack  {-1,1}\right\rbrack$</td><td>$\mathbf{R}$</td></tr><tr><td>最大值</td><td>1</td><td>1</td><td>无</td></tr><tr><td>最小值</td><td>-1</td><td>-1</td><td>无</td></tr><tr><td>最小正周期</td><td>${2\pi }$</td><td>${2\pi }$</td><td>$\pi$</td></tr><tr><td>奇偶性</td><td>奇函数</td><td>偶函数</td><td>奇函数</td></tr><tr><td>单调增区间</td><td>$\left\lbrack  {{2k\pi } - \frac{\pi }{2},{2k\pi } + \frac{\pi }{2}}\right\rbrack  \left( {k \in  \mathbf{Z}}\right)$</td><td>$\left\lbrack  {{2k\pi } - \pi ,{2k\pi }}\right\rbrack  \left( {k \in  \mathbf{Z}}\right)$</td><td>$\left( {{k\pi } - \frac{\pi }{2},{k\pi } + \frac{\pi }{2}}\right) \left( {k \in  \mathbf{Z}}\right)$</td></tr><tr><td>单调减区间</td><td>$\left\lbrack  {{2k\pi } + \frac{\pi }{2},{2k\pi } + \frac{3\pi }{2}}\right\rbrack  \left( {k \in  \mathbf{Z}}\right)$</td><td>$\left\lbrack  {{2k\pi },{2k\pi } + \pi }\right\rbrack  \left( {k \in  \mathbf{Z}}\right)$</td><td>无</td></tr><tr><td>图像</td><td>[失效外部图片：bo_d5205277aajc73fu465g_32.jpg]</td><td>[失效外部图片：bo_d5205277aajc73fu465g_32.jpg]</td><td>[失效外部图片：bo_d5205277aajc73fu465g_32.jpg]</td></tr></table>
