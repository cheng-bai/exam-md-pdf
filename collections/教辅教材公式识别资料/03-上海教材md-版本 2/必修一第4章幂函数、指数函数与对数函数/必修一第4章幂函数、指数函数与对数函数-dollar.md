---
title: 必修一第4章幂函数、指数函数与对数函数-dollar
来源: 沪教版教材
---
# 幂函数、 指数函数与对数函数
...
<table><tr><td>$y = {a}^{x}$</td><td>$a > 1$</td><td>$0 < a < 1$</td></tr><tr><td>图像</td><td>[失效外部图片：bo_d4slocn7aajc73fspklg_10.jpg]</td><td>[失效外部图片：bo_d4slocn7aajc73fspklg_10.jpg]</td></tr><tr><td rowspan="3">图像特征</td><td colspan="2">(1)图像都在 $x$ 轴上方，无限趋近于 $x$ 轴，但永不相交.</td></tr><tr><td colspan="2">(2)过点 $\left( {0,1}\right)$ .</td></tr><tr><td>(3)由左至右图像上升.</td><td>(3)由左至右图像下降.</td></tr><tr><td rowspan="3">函数性质</td><td colspan="2">(1)定义域为 $\mathbf{R}$ ，函数值恒正.</td></tr><tr><td colspan="2">(2)当 $x = 0$ 时， $y = 1$ .</td></tr><tr><td>(3)在 $\mathbf{R}$ 上是严格增函数.</td><td>(3)在 $\mathbf{R}$ 上是严格减函数.</td></tr></table>
...
<table><tr><td>$y = {\log }_{a}x$</td><td>$a > 1$</td><td>$0 < a < 1$</td></tr><tr><td>图像</td><td>[失效外部图片：bo_d4slocn7aajc73fspklg_18.jpg]</td><td>[失效外部图片：bo_d4slocn7aajc73fspklg_18.jpg]</td></tr><tr><td rowspan="3">图像特征</td><td colspan="2">(1)图像都在 $y$ 轴右侧，无限趋近于 $y$ 轴,但永不相交.</td></tr><tr><td colspan="2">(2)过点 $\left( {1,0}\right)$ .</td></tr><tr><td>(3)由左至右图像上升.</td><td>(3)由左至右图像下降.</td></tr><tr><td rowspan="3">函数性质</td><td colspan="2">(1)定义域为 $\left( {0, + \infty }\right)$ .</td></tr><tr><td colspan="2">(2)当 $x = 1$ 时， $y = 0$ .</td></tr><tr><td>(3) 在区间 $\left( {0, + \infty }\right)$ 上是严格增函数.</td><td>(3)在区间 $\left( {0, + \infty }\right)$ 上是严格减函数.</td></tr></table>
