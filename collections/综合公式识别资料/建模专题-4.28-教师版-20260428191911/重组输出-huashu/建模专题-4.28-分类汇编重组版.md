# 建模专题 4.28 教师版｜分类汇编重组版

> 重组原则：不再按原讲义的“求值/范围/难度”排列，而按建模时的第一识别动作分类：测量、平面区域、立体几何、函数参数、坐标化、路径通行、光影观测、综合探究。

## 使用建议

- 第一轮：只训练“读题后选模型”，每题先写变量与目标，不急着算。
- 第二轮：同一模块内比较母题差异，归纳“约束怎么来、目标怎么写”。
- 第三轮：跨模块混排，训练学生从真实情境中识别数学结构。

## 分类总览
- **测量求值：方位角、仰角与正弦/余弦定理**（7题）：先画测量三角形，用正弦定理/余弦定理/仰角三角函数把不可测距离转化为可测数据。
- **平面区域最值：面积、长度、折叠与截取**（20题）：几何约束先转变量关系，再把目标面积/长度化为一元函数。
- **立体几何最值：体积、表面积与容器设计**（16题）：抓轴截面、旋转截面或相似关系，把空间量转化为半径、高、母线。
- **函数与参数模型：导数、单调性与区间约束**（4题）：从情境中抽取目标函数或参数条件，重点训练定义域、约束与临界值。
- **坐标化与圆锥曲线模型：抛物线、椭圆、向量轨迹**（3题）：图形复杂时主动建系，用方程、切线、参数或向量表达几何关系。
- **路径与通行模型：选址、运输、转弯、过道**（5题）：寻找临界位置或成本函数，常见动作是相切、恰好通过、时间费用最小。
- **光影与空间观测：太阳高度、阴影、异地测高**（15题）：把平行光、仰角和投影转化为空间/平面三角关系。
- **综合探究压轴：多阶段建模与论证**（1题）：题干长、变量多，按“假设—变量—约束—目标—验证”拆解。

## 测量求值：方位角、仰角与正弦/余弦定理

**教学定位**：先画测量三角形，用正弦定理/余弦定理/仰角三角函数把不可测距离转化为可测数据。

| 重组编号 | 原位置 | 识别关键词 |
|---|---|---|
| M1-01 | 原求值 第1题（源行7） | 正弦定理 |
| M1-02 | 原求值 第2题（源行37） | 正弦定理、最短 |
| M1-03 | 原求值 第3题（源行75） | 建模转化 |
| M1-04 | 原求值 第4题（源行107） | 仰角、测得、余弦定理 |
| M1-05 | 原求值 第5题（源行135） | 仰角、测得 |
| M1-06 | 原范围 第7题（源行899） | 最短 |
| M1-07 | 原三角 第7题（源行1533） | 面积、最大、相切 |

### M1-01｜原求值 第1题

> 讲法抓手：先让学生说出“变量是什么、目标量是什么、约束关系来自哪里”。
...
**教学定位**：几何约束先转变量关系，再把目标面积/长度化为一元函数。

| 重组编号 | 原位置 | 识别关键词 |
|---|---|---|
| M2-01 | 原范围 第4题（源行287） | 面积 |
| M2-02 | 原范围 第4题（源行415） | 面积、导数 |
| M2-03 | 原范围 第5题（源行443） | 正弦定理、面积 |
| M2-04 | 原范围 第6题（源行487） | 最大 |
| M2-05 | 原范围 第8题（源行561） | 正弦定理、最小、折叠 |
| M2-06 | 原范围 第9题（源行599） | 费用、相切 |
| M2-07 | 原范围 第2题（源行673） | 面积、最大 |
| M2-08 | 原范围 第5题（源行821） | 最小、相切 |
| M2-09 | 原函数相关 第2题（源行1107） | 建模转化 |
| M2-10 | 原函数相关 第5题（源行1205） | 最短 |
| M2-11 | 原函数相关 第6题（源行1247） | 正弦定理、面积、最大 |
| M2-12 | 原三角 第2题（源行1387） | 面积 |
| M2-13 | 原三角 第3题（源行1417） | 体积 |
| M2-14 | 原三角 第4题（源行1459） | 余弦定理 |
| M2-15 | 原三角 第5题（源行1489） | 仰角、测得 |
| M2-16 | 原三角 第6题（源行1511） | 余弦定理、最大 |
| M2-17 | 原三角 第8题（源行1585） | 最小 |
| M2-18 | 原三角 第10题（源行1635） | 导数、最大 |
| M2-19 | 原三角大题 第3题（源行1937） | 建模转化 |
| M2-20 | 原三角大题 第8题（源行2183） | 面积、向量 |
...
**教学定位**：抓轴截面、旋转截面或相似关系，把空间量转化为半径、高、母线。

| 重组编号 | 原位置 | 识别关键词 |
|---|---|---|
| M3-01 | 原范围 第1题（源行333） | 体积、导数、最大 |
| M3-02 | 原范围 第2题（源行361） | 体积、导数、最大 |
| M3-03 | 原范围 第3题（源行393） | 面积、最大 |
| M3-04 | 原范围 第1题（源行637） | 面积、体积、最小 |
| M3-05 | 原范围 第4题（源行771） | 建模转化 |
| M3-06 | 原范围 第8题（源行931） | 最大 |
| M3-07 | 原范围 第9题（源行969） | 面积、体积、表面积、费用、最小 |
| M3-08 | 原函数相关 第1题（源行1039） | 建模转化 |
| M3-09 | 原三角 第1题（源行1353） | 面积、费用 |
| M3-10 | 原三角 第9题（源行1611） | 建模转化 |
| M3-11 | 原三角 第11题（源行1657） | 体积、导数、单调性、最大 |
| M3-12 | 原立体几何 第1题（源行1693） | 体积、相切 |
| M3-13 | 原立体几何 第2题（源行1723） | 面积、表面积、单调性、最大 |
| M3-14 | 原立体几何 第3题（源行1747） | 面积、表面积 |
| M3-15 | 原立体几何 第4题（源行1779） | 面积、表面积 |
| M3-16 | 原立体几何 第5题（源行1809） | 体积、相切 |
...
**教学定位**：从情境中抽取目标函数或参数条件，重点训练定义域、约束与临界值。

| 重组编号 | 原位置 | 识别关键词 |
|---|---|---|
| M4-01 | 原范围 第1题（源行165） | 导数 |
| M4-02 | 原函数相关 第3题（源行1129） | 最大 |
| M4-03 | 原函数相关 第4题（源行1171） | 建模转化 |
| M4-04 | 原函数相关 第8题（源行1317） | 单调性 |
...
## 坐标化与圆锥曲线模型：抛物线、椭圆、向量轨迹

**教学定位**：图形复杂时主动建系，用方程、切线、参数或向量表达几何关系。

| 重组编号 | 原位置 | 识别关键词 |
|---|---|---|
| M5-01 | 原范围 第2题（源行207） | 面积、抛物线、最小、相切 |
| M5-02 | 原范围 第3题（源行245） | 面积、单调性、抛物线、最大 |
| M5-03 | 原函数相关 第7题（源行1281） | 面积、体积、导数、椭圆、最大 |
...
**教学定位**：寻找临界位置或成本函数，常见动作是相切、恰好通过、时间费用最小。

| 重组编号 | 原位置 | 识别关键词 |
|---|---|---|
| M6-01 | 原范围 第3题（源行721） | 最小 |
| M6-02 | 原范围 第6题（源行863） | 费用 |
| M6-03 | 原范围 第10题（源行999） | 最短 |
| M6-04 | 原三角大题 第1题（源行1837） | 转弯 |
| M6-05 | 原三角大题 第2题（源行1887） | 过道、最小 |
...
## 光影与空间观测：太阳高度、阴影、异地测高

**教学定位**：把平行光、仰角和投影转化为空间/平面三角关系。

| 重组编号 | 原位置 | 识别关键词 |
|---|---|---|
| M7-01 | 原范围 第7题（源行523） | 最短 |
| M7-02 | 原三角大题 第4题（源行1997） | 转弯、最大 |
| M7-03 | 原三角大题 第5题（源行2053） | 最小 |
| M7-04 | 原三角大题 第6题（源行2103） | 太阳 |
| M7-05 | 原三角大题 第7题（源行2149） | 仰角、太阳、最大 |
| M7-06 | 原三角大题 第9题（源行2201） | 最大 |
| M7-07 | 原三角大题 第10题（源行2255） | 面积、最大 |
| M7-08 | 原三角大题 第11题（源行2333） | 面积、最大 |
| M7-09 | 原三角大题 第12题（源行2423） | 最小 |
| M7-10 | 原三角大题 第1题（源行2475） | 影子 |
| M7-11 | 原三角大题 第3题（源行2537） | 仰角、正弦定理 |
| M7-12 | 原三角大题 第4题（源行2581） | 仰角、测得 |
| M7-13 | 原三角大题 第5题（源行2631） | 影子 |
| M7-14 | 原三角大题 第6题（源行2669） | 仰角、测得 |
| M7-15 | 原三角大题 第7题（源行2695） | 仰角、测得、椭圆 |
...
**教学定位**：题干长、变量多，按“假设—变量—约束—目标—验证”拆解。

| 重组编号 | 原位置 | 识别关键词 |
|---|---|---|
| M8-01 | 原三角大题 第2题（源行2505） | 正弦定理 |
