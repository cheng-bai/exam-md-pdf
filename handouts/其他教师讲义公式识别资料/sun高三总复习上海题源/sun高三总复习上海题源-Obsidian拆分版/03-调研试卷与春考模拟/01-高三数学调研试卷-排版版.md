...
<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_236_1111_1026_287_289_0.jpg" alt="" class="pdf-image image-compact" />
...
<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_236_1129_1601_263_261_0.jpg" alt="" class="pdf-image image-compact" />
...
12. 定义两个点集 $S\text{ 、 }T$ 之间的距离集为 $d\left( {S, T}\right)  = \{ \left| {{PQ} \mid P \in  S, Q \in  T\} \text{ ,其中 }}\right| {PQ} \mid$ 表示两点 $P\text{ 、 }Q$ 之间的距离,已知 $k\text{ 、 }t \in  \mathbf{R}, S = \{ \left( {x, y}\right) \mid y = {kx} + t, x \in  \mathbf{R}\}$ , $T = \{ \left( {x, y}\right) \mid y = \sqrt{4{x}^{2} + 1}, x \in  \mathbf{R}\}$ ，若 $d\left( {S, T}\right)  = \left( {1, + \infty }\right)$ ，则 $t$ 的值为___

## 二. 选择题

13. 如图是根据 $x\text{ 、 }y$ 的观测数据 $\left( {{x}_{i},{y}_{i}}\right) \left( {i = 1,2,\cdots ,{10}}\right)$ 得到的散点图,可以判断变量 $x$ 、 $y$ 具有线性相关关系的图是 ( )

<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_237_264_380_236_201_0.jpg" alt="" class="pdf-image image-standard" />

<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_237_558_380_239_201_0.jpg" alt="" class="pdf-image image-standard" />

<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_237_854_381_236_201_0.jpg" alt="" class="pdf-image image-standard" />

<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_237_1147_380_236_202_0.jpg" alt="" class="pdf-image image-standard" />
...
15. 已知直线 $m\text{ 、 }n$ 及平面 $\alpha$ ,其中 $m \parallel n$ ,那么在平面 $\alpha$ 内到两条直线 $m\text{ 、 }n$ 距离相等的点的集合可能是:① 一条直线；② 一个平面；③ 一个点；④ 空集. 其中正确的是( )
...
<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_238_510_1172_615_332_0.jpg" alt="" class="pdf-image image-standard" />
...
<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_239_1046_553_320_282_0.jpg" alt="" class="pdf-image image-compact" />
