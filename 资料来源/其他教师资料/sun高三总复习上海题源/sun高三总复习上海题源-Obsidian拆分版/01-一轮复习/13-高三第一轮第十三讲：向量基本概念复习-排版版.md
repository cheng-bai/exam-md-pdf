...
(2) $\overrightarrow{a} \parallel \overrightarrow{b}$ 的充要条件是 ${x}_{1}{y}_{2} = {x}_{2}{y}_{1}$ .
...
<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_65_681_297_283_234_0.jpg" alt="" class="pdf-image image-standard" />

## 一、基本题型

1、已知向量 $\overrightarrow{a} = \left( {\sqrt{3},1}\right) ,\overrightarrow{b} = \left( {\sin \alpha  - m,\cos \alpha }\right) \alpha  \in  R$ ，若 $\overrightarrow{a} \parallel \overrightarrow{b}$ ，则实数 $m$ 的最小值为___；
...
<img src="../assets/images/bo_d4nv1rjef24c73bbkrtg_69_1082_328_266_247_0.jpg" alt="" class="pdf-image image-compact" />
