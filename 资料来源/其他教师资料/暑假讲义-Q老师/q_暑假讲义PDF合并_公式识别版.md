...
则 $\mathop{\lim }\limits_{{n \rightarrow   + \infty }}\frac{{y}_{n} - 1}{{x}_{n} - 1} =$ **_， $\mathop{\lim }\limits_{{n \rightarrow   + \infty }}\frac{{y}_{n} - \frac{3}{5}}{{x}_{n} - \frac{4}{5}} =$ \_**
